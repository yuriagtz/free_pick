      ...
      <div className="container max-w-4xl mx-auto">
        ...
        <Card className="shadow-lg">
          <CardContent className="pt-8 pb-8 px-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">個人情報保護方針（プライバシーポリシー）</h1>

            <div className="prose prose-gray max-w-none space-y-6">
              <section>
                <p className="text-gray-700 leading-relaxed mb-6">
                  株式会社MagiTech Tool Lab（以下、「当社」といいます。）は、本ウェブサイトおよび当社が管理・運営するツール・コミュニティ（以下、「本サービス」といいます）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます）を定めます。
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  利用目的の変更を行った場合には、変更後の目的について、当社所定の方法により、ユーザーに通知し、本ウェブサイトに公表するものとします。
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-8 mb-4">
              ...
              <section>
                ...
                <div className="text-gray-700 leading-relaxed space-y-1">
                  <p>住所：東京都品川区東五反田5-21-15 メタリオンOSビル3F-8</p>
                  <p>社名：株式会社MagiTech Tool Lab</p>
                  <p>代表取締役：澤田 和志</p>
                  <p>Eメールアドレス：info@magitech-tool-lab.jp</p>
                </div>
              </section>
